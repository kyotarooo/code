...
base_atoms = [                                   #(六方晶site or 立方晶site) : target atom
    ...
    [1, 0.000000, 0.000000, 0.000000, 5.024066], #(k):4
    ...
    [2, 0.000000, 0.000000, 3.552551, 5.652074], #(k):12
    [2, 0.000000, 1.538300, 0.888138, 5.652074], #(k):13
    [2, 0.000000, 0.000000, 0.000000, 8.164108], #(h):14
    [2, 0.000000, 1.538300, 2.664413, 8.164108], #(h):15
]
#1: Si
#2: C
