...
echo "$full_output_dir" > ${full_output_dir}/fullpass.txt
# lammps .in file
...
# MD displacement data
mkdir -p $full_output_dir/disp_data
# theorical solution data
mkdir -p $full_output_dir/ux_data
