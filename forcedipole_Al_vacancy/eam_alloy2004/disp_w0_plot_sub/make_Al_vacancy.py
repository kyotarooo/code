...
for i in range(len(units_cell_x)):
    with open(f"{output_dir}/in_file/{filename[i]}", 'w') as f:  
        ...
        f.write(f'lattice custom {lattice_const} a1 1.0 0.0 0.0 a2 0.0 1.0 0.0 a3 0.0 0.0 1.0 basis 0.0 0.0 0.0 basis 0.0 0.5 0.5 basis 0.5 0.0 0.5 basis 0.5 0.5 0.0\n')
