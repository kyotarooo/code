...
def main():
    ...
    for cutoff in range(cutoff_num):
        mk_dir = f"/Users/kyou/Library/CloudStorage/Box-Box/code/InclusionStress-20251203/input_range20nm/disp_{cutoff}_{a_core_width}_rxr"
        os.makedirs(mk_dir, exist_ok=True)
        with open(f'{mk_dir}/material.inp', "w") as f_ma_d:
            f_ma_d.write("1.0 0.0 0.0\n")
        ...
        with open(f'{mk_dir}/inclusion.inp', "w") as f_incl_d:
            ...
            for i in range(9):
                ...
                if i == 2 or i == 5:
                    f_incl_d.write("\n")
            f_incl_d.write("\n")
            f_incl_d.write("1.0 0.0 0.0\n")
            f_incl_d.write("0.0 1.0 0.0\n")
            f_incl_d.write("0.0 0.0 1.0\n")
    ...
    ######## displacement method ########     
    mk_dir = f"/Users/kyou/Library/CloudStorage/Box-Box/code/InclusionStress-20251203/input_range20nm/residual_{a_core_width}"
    os.makedirs(mk_dir, exist_ok=True)
    with open(f'{mk_dir}/material.inp', "w") as f_ma:
        f_ma.write("1.0 0.0 0.0\n")
    ...
    with open(f'{mk_dir}/grid.inp', "w") as f_grid:
        f_grid.write("2\n")
        f_grid.write("200 200 200\n")
