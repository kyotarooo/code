...
def main():
    ...
    with open(f"{output_dir}/force_dipole/force_dipole_{atom_type_to_delete}/data_p_eV.inp", "r") as f_eV,\
         open(f"{output_dir}/force_dipole/force_dipole_{atom_type_to_delete}/data_p_J.inp", "r") as f_J,\
    ...
    #plt.ylim(top=-2.0)
    # --- make dir & save png ---
    save_dir = f"{output_dir}/dipole_graph/delete_{atom_type_to_delete}"
