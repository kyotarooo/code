...
def main():
    with open(f"{output_dir}/sumstress/sumstress_{atom_type_to_delete}/defect_J_sumstress2.txt", "r") as f_pe_J,\
         open(f"{output_dir}/sumstress/sumstress_{atom_type_to_delete}/defect_eV_sumstress2.txt", "r") as f_pe_eV,\
         open(f"{output_dir}/sumstress/sumstress_{atom_type_to_delete}/defect_J_sumstress.txt", "r") as f_de_J,\
         open(f"{output_dir}/sumstress/sumstress_{atom_type_to_delete}/defect_eV_sumstress.txt", "r") as f_de_eV:
    ...
    with open(f"{output_dir}/force_dipole/force_dipole_{atom_type_to_delete}/force_dipole_eV.txt", "w") as f_eV:
    ...
    with open(f"{output_dir}/force_dipole/force_dipole_{atom_type_to_delete}/force_dipole_J.txt", "w") as f_J:
        for i in range(id_max):
            i += 1
            for k in range(9):
