#ifndef __INCSTR_ELLIPTIC_H_
#define __INCSTR_ELLIPTIC_H_

#define NELLIPTIC 501

typedef struct __elliptic_t_ {
  int n;
  double d;
  double *e, *f;
  double **p;
...
extern void INCSTR_MakeEllipticIntegralTable(void);

extern double INCSTR_EllipticIntegralEk(double m);

extern double INCSTR_EllipticIntegralFk(double m);

extern double INCSTR_EllipticIntegralPik(double h, double m);
