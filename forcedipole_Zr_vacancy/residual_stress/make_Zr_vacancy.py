...
for i in range(len(units_cell_x)):
    num = f"{units_cell_x[i]}*{units_cell_y[i]}*{units_cell_z[i]}"
...
for i in tqdm(range(len(units_cell_x))):
    with open(f"/Users/kyou/Library/CloudStorage/Box-Box/lammps/pointdefects_Zr/in_file/{filename[i]}", 'w') as f:
        ...
        # HCP格子
        # f.write('lattice custom 3.234 a1 1.0 0.0 0.0 a2 -0.5 0.8660254 0.0 a3 0.0 0.0 1.5980210266 '
        #        'basis 0.0 0.0 0.0 basis 0.6666667 0.3333333 0.5\n')#EAM#3 
        f.write('lattice custom 3.220 a1 1.0 0.0 0.0 a2 -0.5 0.8660254 0.0 a3 0.0 0.0 1.6195652174 '
                'basis 0.0 0.0 0.0 basis 0.6666667 0.3333333 0.5\n')#EAM#2 
        ...
        f.write('pair_style eam/alloy\n')
        f.write('pair_coeff * * /Users/kyou/Library/CloudStorage/Box-Box/interatomic_potentials/Zr_2.eam.fs Zr\n')#EAM#2
