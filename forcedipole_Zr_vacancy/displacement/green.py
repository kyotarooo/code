...
def main():
    for l in range(file_num):
        ...
        with open(f"/Users/kyou/Library/CloudStorage/Box-Box/dump/vacancy_Zr/displacement/displacement{l}.inp", "r") as f_disp: 
        ...
        with open(f"/Users/kyou/Library/CloudStorage/Box-Box/force_dipole/Zr/vacancy/displacement/data_p_J.inp", "a") as f_J,\
             open(f"/Users/kyou/Library/CloudStorage/Box-Box/force_dipole/Zr/vacancy/displacement/data_p_eV.inp", "a") as f_eV:
