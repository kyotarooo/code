...
def open_window():
    ...
    elastic_dipole_layout = [
        ...
        [
            eg.Text("  XX"),
            eg.Input("0.0", key="-elastic_dipole_xx-"),
            eg.Text("XY"),
            eg.Input("0.0", key="-elastic_dipole_xy-"),
            eg.Text("XZ"),
            eg.Input("0.0", key="-elastic_dipole_xz-"),
        ],
        [
            eg.Text("  YX"),
            eg.Input("0.0", key="-elastic_dipole_yx-"),
            eg.Text("YY"),
            eg.Input("0.0", key="-elastic_dipole_yy-"),
            eg.Text("YZ"),
            eg.Input("0.0", key="-elastic_dipole_yz-"),
        ],
        [
            eg.Text("  ZX"),
            eg.Input("0.0", key="-elastic_dipole_zx-"),
            eg.Text("ZY"),
            eg.Input("0.0", key="-elastic_dipole_zy-"),
            eg.Text("ZZ"),
            eg.Input("0.0", key="-elastic_dipole_zz-"),
        ],
        [eg.Text("Orientation")],
        [
            eg.Text("  XX"),
            eg.Input("0.0", key="-elastic_dipole_oxx-"),
            eg.Text("XY"),
            eg.Input("0.0", key="-elastic_dipole_oxy-"),
            eg.Text("XZ"),
            eg.Input("0.0", key="-elastic_dipole_oxz-"),
        ],
        [
            eg.Text("  YX"),
            eg.Input("0.0", key="-elastic_dipole_oyx-"),
            eg.Text("YY"),
            eg.Input("0.0", key="-elastic_dipole_oyy-"),
            eg.Text("YZ"),
            eg.Input("0.0", key="-elastic_dipole_oyz-"),
        ],
        [
            eg.Text("  ZX"),
            eg.Input("0.0", key="-elastic_dipole_ozx-"),
            eg.Text("ZY"),
            eg.Input("0.0", key="-elastic_dipole_ozy-"),
            eg.Text("ZZ"),
            eg.Input("0.0", key="-elastic_dipole_ozz-"),
        ],
        [eg.HSeparator()],
        ...
        for i in range(elastic_dipole.get_num()):
            ...
            for vector in parameter:
                for x in vector:
                    f.write(f"{x:e} ")
                f.write("\n")
            orientation = elastic_dipole.get_orientation(i)
            for vector in orientation:
                for x in vector:
                    f.write(f"{x:e} ")
                f.write("\n")
...
def main():
    ...
    while window.is_alive():
        ...
        if event == "-add_elastic_dipole-":
            ...
            parameter = [
                [
                    float(values["-elastic_dipole_xx-"]),
                    float(values["-elastic_dipole_xy-"]),
                    float(values["-elastic_dipole_xz-"]),
                ],
                [
                    float(values["-elastic_dipole_yx-"]),
                    float(values["-elastic_dipole_yy-"]),
                    float(values["-elastic_dipole_yz-"]),
                ],
                [
                    float(values["-elastic_dipole_zx-"]),
                    float(values["-elastic_dipole_zy-"]),
                    float(values["-elastic_dipole_zz-"]),
                ],
            ]
            orientation = [
                [
                    float(values["-elastic_dipole_oxx-"]),
                    float(values["-elastic_dipole_oxy-"]),
                    float(values["-elastic_dipole_oxz-"]),
                ],
                [
                    float(values["-elastic_dipole_oyx-"]),
                    float(values["-elastic_dipole_oyy-"]),
                    float(values["-elastic_dipole_oyz-"]),
                ],
                [
                    float(values["-elastic_dipole_ozx-"]),
                    float(values["-elastic_dipole_ozy-"]),
                    float(values["-elastic_dipole_ozz-"]),
                ],
            ]
            eigen_strain = 0
