...
// Adaptive element length control
#define COSINE_ANGLE_AT_MINIMUM_ELEMENT_LENGTH -0.7
...
#define TIME_INTEGRAL_TRAPEZOID 0
#define TIME_INTEGRAL_RK1 1
#define TIME_INTEGRAL_RK2 2
#define TIME_INTEGRAL_RK3 3
#define TIME_INTEGRAL_RK4 4

// Trapezoidal time integration
#define NMAX_TRAPEZOIDAL_ITERATIONS 10
#define TRAPEZOIDAL_EPS 1.0e-08
...
// Inclusion types
#define SPHERICAL_INCLUSION 0
#define CYLINDERICAL_INCLUSION 1
#define CUBOIDAL_INCLUSION 2
